...
export default class extends React.Component {
  ...
  render() {
    ...
    return (
      <Trans className="jokes">
        <nav>
          { this.state.title }
          <i 
            className="fa-commenting-o create" 
            onClick={ () => this.props.onViewChange('#jokesCreate') } />
        </nav>
          ...
          <header>
            ...
            <div 
              onClick={ 
                ...
                () => this.bridge(store.userData.data.user_id) : _ => _
              }
              className="info">
              <div className="name">
              ...
              <div className="joke-box" key={ i }>
                <div className="person">
                  ...
                  <div className="user-info">
                    <div 
                      onClick={ () => this.componentDidMount(v.user_id) }
                      className="user-name" >
                      { v.username }
                ...
                <div className="comment-boxes">
                  {
                  	v.comments.map((z, k) =>
                        ...
                        <span 
                          onClick={ () => this.componentDidMount(z.user_id) }
